...
//    float zoomSpeed = 2.0f * deltaTime;
//
//    if (window->KeyHold(GLFW_KEY_Z)) {
//        // Zoom in (reduce logic space)
//        logicSpace.width -= zoomSpeed;
//        logicSpace.height -= zoomSpeed;
//
//        // Prevenim prea mult zoom
//        if (logicSpace.width < 1.0f) logicSpace.width = 1.0f;
//        if (logicSpace.height < 1.0f) logicSpace.height = 1.0f;
//    }
//
//    if (window->KeyHold(GLFW_KEY_X)) {
//        // Zoom out (crestem logic space)
//        logicSpace.width += zoomSpeed;
//        logicSpace.height += zoomSpeed;
//
//        // Prevenim prea mult zoom out
//        if (logicSpace.width > 10.0f) logicSpace.width = 10.0f;
//        if (logicSpace.height < 10.0f) logicSpace.height = 10.0f;
//    }
//
//}
//
